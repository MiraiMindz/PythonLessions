...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/media/Arquivos/Programming/Lessons/PythonLessons'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/media/Arquivos/Programming/Lessons/PythonLessons/bin/deactivate.nu'
